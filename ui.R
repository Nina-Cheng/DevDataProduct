...
shinyUI(pageWithSidebar(
        ...
        sidebarPanel(                     
                ...
                p(strong(em("New User Documentation:",a("Instructions to use App",href="https://github.com/Nina-Cheng/DevDataProduct/blob/gh-pages/Instructions%20for%20Using%20the%20FindCarApp.pdf"))))
